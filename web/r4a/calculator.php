...
$AVG_DAILY_NGAS = 1000/365;   /* 1000 therms NATURAL GAS per year */
$AVG_DAILY_PROP = 1100/365;   /* 1100 gallons PROPANE per year */
$AVG_DAILY_HOIL = 750/365;    /* 750 gallons HEATING OIL per year */
$AVG_DAILY_WOOD = 50/365;     /* 50 cords (non-sustainable) WOOD per year */
$AVG_DAILY_TRASH = 4.5;       /* 4.5 lbs TRASH per person, per day */
$AVG_DAILY_WATER = 100;       /* 100 gallons WATER per person, per day */
...
$pt_pct = sprintf("%0.1f",($pt_ptrl / $pt_div / 100) / $AVG_DAILY_PTRL * 100);
$wvo_pct = sprintf("%0.1f",($wvo_ptrl / $wvo_div / 100) / $AVG_DAILY_PTRL * 100);
...
<br>
Public Transportation: <input type=text size=6 name=pt_ptrl value="<?php echo $pt_ptrl; ?>"> miles
